...
$(document).ready(function() {
    $('.upper-elements-cell').click(function() {
        var selected_element = $(this).html();
        var selected_element_data = getObjects(periodic_data, 'symbol', selected_element);

        var html_data = '';
        html_data += "<br>Name: " + selected_element_data[0].name + "<br>";
				html_data += "atomicNumber: " + selected_element_data[0].atomicNumber + "<br>";
				html_data += "atomicMass: " + selected_element_data[0].atomicMass + "<br>";
				html_data += "standardState: " + selected_element_data[0].standardState + "<br>";
        $('#put-data-elements').html('');
        $('#put-data-elements').html(html_data);
